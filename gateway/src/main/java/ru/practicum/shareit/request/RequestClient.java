...
public class RequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> getIRequestsBesidesUsers(Long userId, Integer from, Integer size) {
        Map<String, Object> params = Map.of("from", from, "size", size);
    ...
    public ResponseEntity<Object> createRequest(Long userId, ItemRequestCreateDto requestCreateDto) {
